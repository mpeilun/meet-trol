...
export const { setPlayedSecond, updateEyeTracking, setQuestionLocate, isLooking, setVideoUrl } = courseSlice.actions
...
export const selectVideoUrl = (state: RootState) => state.course.videoUrl
